...
fecha_hasta = '2021-12-18'

facturas_df = consulta_facturas(Cedula, fecha_desde, fecha_hasta)
total_gastado = facturas_df['IMPORTE'].sum()
numero_compras = facturas_df['FACTURA'].nunique()
...
print(f"Número de Compras: {numero_compras}")
print(f"Promedio de Gasto por Compra: ${promedio_gasto:.2f}")
print(f"Grupo: {grupo}")
# %%
